...
//using OA.Utility;
//using OA.Utility.Extensions;
//using OA.Web.Mvc.Properties;
//using OA.Web.Mvc.Security;
...
//                && method.ReturnType != typeof(JsonResult) && method.ReturnType != typeof(Task<JsonResult>))
//            {
